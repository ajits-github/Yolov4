...
print("_BASE_DIR in cfg.py______________",_BASE_DIR)
Cfg = EasyDict()
...
print("Train_label in cfg.py______________",Cfg.train_label)
print("val_label in cfg.py______________",Cfg.val_label)